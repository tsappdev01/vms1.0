...
typedef NS_ENUM(int, PatternPos) {
    CCW_center = 0,
 ...
 * The Aruco module
 *
 * Member classes: `DetectorParameters`, `EstimateParameters`, `Board`, `GridBoard`, `Dictionary`, `CharucoBoard`
 *
 * Member enums: `CornerRefineMethod`, `PatternPos`, `PREDEFINED_DICTIONARY_NAME`
 */
 ...
 * @see `undistort`, `+estimatePoseSingleMarkers:markerLength:cameraMatrix:distCoeffs:rvecs:tvecs:_objPoints:estimateParameters:`, `+estimatePoseBoard:ids:board:cameraMatrix:distCoeffs:rvec:tvec:useExtrinsicGuess:`
 *
 */
...
//
//  void cv::aruco::estimatePoseSingleMarkers(vector_Mat corners, float markerLength, Mat cameraMatrix, Mat distCoeffs, Mat& rvecs, Mat& tvecs, Mat& _objPoints = Mat(), Ptr_EstimateParameters estimateParameters = EstimateParameters::create())
//
/**
 ...
 * @see `+detectMarkers:dictionary:corners:ids:parameters:rejectedImgPoints:`
 ...
 * @see `PatternPos`
 */
+ (void)estimatePoseSingleMarkers:(NSArray<Mat*>*)corners markerLength:(float)markerLength cameraMatrix:(Mat*)cameraMatrix distCoeffs:(Mat*)distCoeffs rvecs:(Mat*)rvecs tvecs:(Mat*)tvecs _objPoints:(Mat*)_objPoints estimateParameters:(EstimateParameters*)estimateParameters NS_SWIFT_NAME(estimatePoseSingleMarkers(corners:markerLength:cameraMatrix:distCoeffs:rvecs:tvecs:_objPoints:estimateParameters:));
