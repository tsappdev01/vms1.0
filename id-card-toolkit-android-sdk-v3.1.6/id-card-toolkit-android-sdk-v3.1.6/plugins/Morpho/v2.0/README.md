...
Morpho Smart SDK version: 6.22.0.0
Supported ABIs: armeabi-v7a only

## Contents
- morpho-plugin-release.aar  - Original vendor AAR (reference)
- dependencies/classes.jar   - Java classes compiled against Morpho SDK 6.22.0.0
...
## Build
  MORPHO_SDK_VERSION=2 bash scripts/build_plugin_aars.sh
